...
void VehiclePlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  this->joints[0]->SetAttribute("suspension_erp", 0, 60.15);
  this->joints[0]->SetAttribute("suspension_cfm", 0, 0.1);

  this->joints[1]->SetAttribute("suspension_erp", 0, 60.15);
  this->joints[1]->SetAttribute("suspension_cfm", 0, 0.1);
/*
  this->joints[2]->SetAttribute("suspension_erp", 0, 3.15);
  this->joints[2]->SetAttribute("suspension_cfm", 0, 0.4);

  this->joints[3]->SetAttribute("suspension_erp", 0, 3.15);
  this->joints[3]->SetAttribute("suspension_cfm", 0, 0.4);*/
